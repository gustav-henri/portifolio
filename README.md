...
<body>
    ...
    <div class="modal" id="modal1" tabindex="-1">
        <div class="modal-dialog"><!DOCTYPE html>
<html lang="pt-br">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Minha Biblioteca: Uma Webpage Personalizada</h5><!DOCTYPE html>
<html lang="pt-br">
    ...
    <div class="modal" id="modal2" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>O projeto consiste em uma aplicação web interativa, desenvolvida com HTML, CSS, e Jav<!DOCTYPE html>
<html lang="pt-br">
